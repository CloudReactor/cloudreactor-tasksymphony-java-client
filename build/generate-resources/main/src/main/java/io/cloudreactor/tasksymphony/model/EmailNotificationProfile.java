...
@JsonPropertyOrder({
  ...
  EmailNotificationProfile.JSON_PROPERTY_NAME,
  EmailNotificationProfile.JSON_PROPERTY_DESCRIPTION,
  EmailNotificationProfile.JSON_PROPERTY_DASHBOARD_URL,
  EmailNotificationProfile.JSON_PROPERTY_CREATED_BY_USER,
  EmailNotificationProfile.JSON_PROPERTY_CREATED_BY_GROUP,
  EmailNotificationProfile.JSON_PROPERTY_RUN_ENVIRONMENT,
  EmailNotificationProfile.JSON_PROPERTY_CREATED_AT,
  EmailNotificationProfile.JSON_PROPERTY_UPDATED_AT,
  EmailNotificationProfile.JSON_PROPERTY_TO_ADDRESSES,
  EmailNotificationProfile.JSON_PROPERTY_CC_ADDRESSES,
  EmailNotificationProfile.JSON_PROPERTY_BCC_ADDRESSES,
  EmailNotificationProfile.JSON_PROPERTY_SUBJECT_TEMPLATE,
...
public class EmailNotificationProfile {
  ...
  **/
  ...
  public EmailNotificationProfile name(String name) {
  ...
  **/
  ...
  public EmailNotificationProfile description(String description) {
  ...
  **/
  ...
  public EmailNotificationProfile runEnvironment(NameAndUuid runEnvironment) {
  ...
  **/
  ...
  public EmailNotificationProfile toAddresses(List<String> toAddresses) {
    this.toAddresses = JsonNullable.<List<String>>of(toAddresses);
    
    return this;
  }

  public EmailNotificationProfile addToAddressesItem(String toAddressesItem) {
  ...
  **/
  ...
  public EmailNotificationProfile ccAddresses(List<String> ccAddresses) {
    this.ccAddresses = JsonNullable.<List<String>>of(ccAddresses);
    
    return this;
  }

  public EmailNotificationProfile addCcAddressesItem(String ccAddressesItem) {
  ...
  **/
  ...
  public EmailNotificationProfile bccAddresses(List<String> bccAddresses) {
    this.bccAddresses = JsonNullable.<List<String>>of(bccAddresses);
    
    return this;
  }

  public EmailNotificationProfile addBccAddressesItem(String bccAddressesItem) {
  ...
  **/
  ...
  public EmailNotificationProfile subjectTemplate(String subjectTemplate) {
  ...
  **/
  ...
  public EmailNotificationProfile bodyTemplate(String bodyTemplate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EmailNotificationProfile emailNotificationProfile = (EmailNotificationProfile) o;
    return Objects.equals(this.url, emailNotificationProfile.url) &&
        Objects.equals(this.uuid, emailNotificationProfile.uuid) &&
        Objects.equals(this.name, emailNotificationProfile.name) &&
        Objects.equals(this.description, emailNotificationProfile.description) &&
        Objects.equals(this.dashboardUrl, emailNotificationProfile.dashboardUrl) &&
        Objects.equals(this.createdByUser, emailNotificationProfile.createdByUser) &&
        Objects.equals(this.createdByGroup, emailNotificationProfile.createdByGroup) &&
        equalsNullable(this.runEnvironment, emailNotificationProfile.runEnvironment) &&
        Objects.equals(this.createdAt, emailNotificationProfile.createdAt) &&
        Objects.equals(this.updatedAt, emailNotificationProfile.updatedAt) &&
        equalsNullable(this.toAddresses, emailNotificationProfile.toAddresses) &&
        equalsNullable(this.ccAddresses, emailNotificationProfile.ccAddresses) &&
        equalsNullable(this.bccAddresses, emailNotificationProfile.bccAddresses) &&
        Objects.equals(this.subjectTemplate, emailNotificationProfile.subjectTemplate) &&
        Objects.equals(this.bodyTemplate, emailNotificationProfile.bodyTemplate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, uuid, name, description, dashboardUrl, createdByUser, createdByGroup, hashCodeNullable(runEnvironment), createdAt, updatedAt, hashCodeNullable(toAddresses), hashCodeNullable(ccAddresses), hashCodeNullable(bccAddresses), subjectTemplate, bodyTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailNotificationProfile {\n");
