...
@JsonPropertyOrder({
  TaskExecution.JSON_PROPERTY_URL,
  TaskExecution.JSON_PROPERTY_UUID,
  TaskExecution.JSON_PROPERTY_DASHBOARD_URL,
  TaskExecution.JSON_PROPERTY_INFRASTRUCTURE_WEBSITE_URL,
  TaskExecution.JSON_PROPERTY_TASK,
  TaskExecution.JSON_PROPERTY_TASK_VERSION_NUMBER,
  TaskExecution.JSON_PROPERTY_TASK_VERSION_TEXT,
  TaskExecution.JSON_PROPERTY_TASK_VERSION_SIGNATURE,
  TaskExecution.JSON_PROPERTY_COMMIT_URL,
  TaskExecution.JSON_PROPERTY_OTHER_INSTANCE_METADATA,
  TaskExecution.JSON_PROPERTY_HOSTNAME,
  TaskExecution.JSON_PROPERTY_ENVIRONMENT_VARIABLES_OVERRIDES,
  TaskExecution.JSON_PROPERTY_EXECUTION_METHOD,
  TaskExecution.JSON_PROPERTY_STATUS,
  TaskExecution.JSON_PROPERTY_STARTED_BY,
  TaskExecution.JSON_PROPERTY_STARTED_AT,
  TaskExecution.JSON_PROPERTY_FINISHED_AT,
  TaskExecution.JSON_PROPERTY_MARKED_DONE_BY,
  TaskExecution.JSON_PROPERTY_MARKED_DONE_AT,
  TaskExecution.JSON_PROPERTY_MARKED_OUTDATED_AT,
  TaskExecution.JSON_PROPERTY_KILLED_BY,
  TaskExecution.JSON_PROPERTY_KILL_STARTED_AT,
  TaskExecution.JSON_PROPERTY_KILL_FINISHED_AT,
  TaskExecution.JSON_PROPERTY_KILL_ERROR_CODE,
  TaskExecution.JSON_PROPERTY_STOP_REASON,
  TaskExecution.JSON_PROPERTY_LAST_HEARTBEAT_AT,
  TaskExecution.JSON_PROPERTY_FAILED_ATTEMPTS,
  TaskExecution.JSON_PROPERTY_TIMED_OUT_ATTEMPTS,
  TaskExecution.JSON_PROPERTY_EXIT_CODE,
  TaskExecution.JSON_PROPERTY_LAST_STATUS_MESSAGE,
  TaskExecution.JSON_PROPERTY_ERROR_COUNT,
  TaskExecution.JSON_PROPERTY_SKIPPED_COUNT,
  TaskExecution.JSON_PROPERTY_EXPECTED_COUNT,
  TaskExecution.JSON_PROPERTY_SUCCESS_COUNT,
  TaskExecution.JSON_PROPERTY_OTHER_RUNTIME_METADATA,
  TaskExecution.JSON_PROPERTY_CURRENT_CPU_UNITS,
  TaskExecution.JSON_PROPERTY_MEAN_CPU_UNITS,
  TaskExecution.JSON_PROPERTY_MAX_CPU_UNITS,
  TaskExecution.JSON_PROPERTY_CURRENT_MEMORY_MB,
  TaskExecution.JSON_PROPERTY_MEAN_MEMORY_MB,
  TaskExecution.JSON_PROPERTY_MAX_MEMORY_MB,
  TaskExecution.JSON_PROPERTY_WRAPPER_VERSION,
  TaskExecution.JSON_PROPERTY_WRAPPER_LOG_LEVEL,
  TaskExecution.JSON_PROPERTY_DEPLOYMENT,
  TaskExecution.JSON_PROPERTY_PROCESS_COMMAND,
  TaskExecution.JSON_PROPERTY_IS_SERVICE,
  TaskExecution.JSON_PROPERTY_TASK_MAX_CONCURRENCY,
  TaskExecution.JSON_PROPERTY_MAX_CONFLICTING_AGE_SECONDS,
  TaskExecution.JSON_PROPERTY_PREVENT_OFFLINE_EXECUTION,
  TaskExecution.JSON_PROPERTY_PROCESS_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_PROCESS_TERMINATION_GRACE_PERIOD_SECONDS,
  TaskExecution.JSON_PROPERTY_PROCESS_MAX_RETRIES,
  TaskExecution.JSON_PROPERTY_PROCESS_RETRY_DELAY_SECONDS,
  TaskExecution.JSON_PROPERTY_SCHEDULE,
  TaskExecution.JSON_PROPERTY_HEARTBEAT_INTERVAL_SECONDS,
  TaskExecution.JSON_PROPERTY_WORKFLOW_TASK_INSTANCE_EXECUTION,
  TaskExecution.JSON_PROPERTY_API_BASE_URL,
  TaskExecution.JSON_PROPERTY_API_REQUEST_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_API_RETRY_DELAY_SECONDS,
  TaskExecution.JSON_PROPERTY_API_RESUME_DELAY_SECONDS,
  TaskExecution.JSON_PROPERTY_API_ERROR_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_API_TASK_EXECUTION_CREATION_ERROR_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_API_TASK_EXECUTION_CREATION_CONFLICT_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_API_TASK_EXECUTION_CREATION_CONFLICT_RETRY_DELAY_SECONDS,
  TaskExecution.JSON_PROPERTY_API_FINAL_UPDATE_TIMEOUT_SECONDS,
  TaskExecution.JSON_PROPERTY_STATUS_UPDATE_INTERVAL_SECONDS,
  TaskExecution.JSON_PROPERTY_STATUS_UPDATE_PORT,
  TaskExecution.JSON_PROPERTY_STATUS_UPDATE_MESSAGE_MAX_BYTES,
  TaskExecution.JSON_PROPERTY_DEBUG_LOG_TAIL,
  TaskExecution.JSON_PROPERTY_ERROR_LOG_TAIL,
  TaskExecution.JSON_PROPERTY_EMBEDDED_MODE,
  TaskExecution.JSON_PROPERTY_CREATED_AT,
  TaskExecution.JSON_PROPERTY_UPDATED_AT
})
...
public class TaskExecution {
  ...
  **/
  ...
  public TaskExecution status(String status) {
  ...
  **/
  ...
  public TaskExecution stopReason(String stopReason) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, taskExecution.url) &&
        Objects.equals(this.uuid, taskExecution.uuid) &&
        Objects.equals(this.dashboardUrl, taskExecution.dashboardUrl) &&
        Objects.equals(this.infrastructureWebsiteUrl, taskExecution.infrastructureWebsiteUrl) &&
        Objects.equals(this.task, taskExecution.task) &&
        equalsNullable(this.taskVersionNumber, taskExecution.taskVersionNumber) &&
        equalsNullable(this.taskVersionText, taskExecution.taskVersionText) &&
        equalsNullable(this.taskVersionSignature, taskExecution.taskVersionSignature) &&
        Objects.equals(this.commitUrl, taskExecution.commitUrl) &&
        equalsNullable(this.otherInstanceMetadata, taskExecution.otherInstanceMetadata) &&
        equalsNullable(this.hostname, taskExecution.hostname) &&
        equalsNullable(this.environmentVariablesOverrides, taskExecution.environmentVariablesOverrides) &&
        Objects.equals(this.executionMethod, taskExecution.executionMethod) &&
        Objects.equals(this.status, taskExecution.status) &&
        Objects.equals(this.startedBy, taskExecution.startedBy) &&
        Objects.equals(this.startedAt, taskExecution.startedAt) &&
        equalsNullable(this.finishedAt, taskExecution.finishedAt) &&
        Objects.equals(this.markedDoneBy, taskExecution.markedDoneBy) &&
        equalsNullable(this.markedDoneAt, taskExecution.markedDoneAt) &&
        equalsNullable(this.markedOutdatedAt, taskExecution.markedOutdatedAt) &&
        Objects.equals(this.killedBy, taskExecution.killedBy) &&
        equalsNullable(this.killStartedAt, taskExecution.killStartedAt) &&
        equalsNullable(this.killFinishedAt, taskExecution.killFinishedAt) &&
        equalsNullable(this.killErrorCode, taskExecution.killErrorCode) &&
        Objects.equals(this.stopReason, taskExecution.stopReason) &&
        equalsNullable(this.lastHeartbeatAt, taskExecution.lastHeartbeatAt) &&
        Objects.equals(this.failedAttempts, taskExecution.failedAttempts) &&
        Objects.equals(this.timedOutAttempts, taskExecution.timedOutAttempts) &&
        equalsNullable(this.exitCode, taskExecution.exitCode) &&
        equalsNullable(this.lastStatusMessage, taskExecution.lastStatusMessage) &&
        equalsNullable(this.errorCount, taskExecution.errorCount) &&
        equalsNullable(this.skippedCount, taskExecution.skippedCount) &&
        equalsNullable(this.expectedCount, taskExecution.expectedCount) &&
        equalsNullable(this.successCount, taskExecution.successCount) &&
        equalsNullable(this.otherRuntimeMetadata, taskExecution.otherRuntimeMetadata) &&
        equalsNullable(this.currentCpuUnits, taskExecution.currentCpuUnits) &&
        equalsNullable(this.meanCpuUnits, taskExecution.meanCpuUnits) &&
        equalsNullable(this.maxCpuUnits, taskExecution.maxCpuUnits) &&
        equalsNullable(this.currentMemoryMb, taskExecution.currentMemoryMb) &&
        equalsNullable(this.meanMemoryMb, taskExecution.meanMemoryMb) &&
        equalsNullable(this.maxMemoryMb, taskExecution.maxMemoryMb) &&
        equalsNullable(this.wrapperVersion, taskExecution.wrapperVersion) &&
        equalsNullable(this.wrapperLogLevel, taskExecution.wrapperLogLevel) &&
        equalsNullable(this.deployment, taskExecution.deployment) &&
        equalsNullable(this.processCommand, taskExecution.processCommand) &&
        equalsNullable(this.isService, taskExecution.isService) &&
        equalsNullable(this.taskMaxConcurrency, taskExecution.taskMaxConcurrency) &&
        equalsNullable(this.maxConflictingAgeSeconds, taskExecution.maxConflictingAgeSeconds) &&
        equalsNullable(this.preventOfflineExecution, taskExecution.preventOfflineExecution) &&
        equalsNullable(this.processTimeoutSeconds, taskExecution.processTimeoutSeconds) &&
        equalsNullable(this.processTerminationGracePeriodSeconds, taskExecution.processTerminationGracePeriodSeconds) &&
        equalsNullable(this.processMaxRetries, taskExecution.processMaxRetries) &&
        equalsNullable(this.processRetryDelaySeconds, taskExecution.processRetryDelaySeconds) &&
        equalsNullable(this.schedule, taskExecution.schedule) &&
        equalsNullable(this.heartbeatIntervalSeconds, taskExecution.heartbeatIntervalSeconds) &&
        Objects.equals(this.workflowTaskInstanceExecution, taskExecution.workflowTaskInstanceExecution) &&
        Objects.equals(this.apiBaseUrl, taskExecution.apiBaseUrl) &&
        equalsNullable(this.apiRequestTimeoutSeconds, taskExecution.apiRequestTimeoutSeconds) &&
        equalsNullable(this.apiRetryDelaySeconds, taskExecution.apiRetryDelaySeconds) &&
        equalsNullable(this.apiResumeDelaySeconds, taskExecution.apiResumeDelaySeconds) &&
        equalsNullable(this.apiErrorTimeoutSeconds, taskExecution.apiErrorTimeoutSeconds) &&
        equalsNullable(this.apiTaskExecutionCreationErrorTimeoutSeconds, taskExecution.apiTaskExecutionCreationErrorTimeoutSeconds) &&
        equalsNullable(this.apiTaskExecutionCreationConflictTimeoutSeconds, taskExecution.apiTaskExecutionCreationConflictTimeoutSeconds) &&
        equalsNullable(this.apiTaskExecutionCreationConflictRetryDelaySeconds, taskExecution.apiTaskExecutionCreationConflictRetryDelaySeconds) &&
        equalsNullable(this.apiFinalUpdateTimeoutSeconds, taskExecution.apiFinalUpdateTimeoutSeconds) &&
        equalsNullable(this.statusUpdateIntervalSeconds, taskExecution.statusUpdateIntervalSeconds) &&
        equalsNullable(this.statusUpdatePort, taskExecution.statusUpdatePort) &&
        equalsNullable(this.statusUpdateMessageMaxBytes, taskExecution.statusUpdateMessageMaxBytes) &&
        equalsNullable(this.debugLogTail, taskExecution.debugLogTail) &&
        equalsNullable(this.errorLogTail, taskExecution.errorLogTail) &&
        equalsNullable(this.embeddedMode, taskExecution.embeddedMode) &&
        Objects.equals(this.createdAt, taskExecution.createdAt) &&
        Objects.equals(this.updatedAt, taskExecution.updatedAt);
  }
