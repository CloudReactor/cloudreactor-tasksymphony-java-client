 ...
 */
@JsonPropertyOrder({
  PaginatedPagerDutyProfileList.JSON_PROPERTY_COUNT,
  PaginatedPagerDutyProfileList.JSON_PROPERTY_NEXT,
  PaginatedPagerDutyProfileList.JSON_PROPERTY_PREVIOUS,
...
public class PaginatedPagerDutyProfileList {
  ...
  private List<PagerDutyProfile> results = null;


  public PaginatedPagerDutyProfileList count(Integer count) {
  ...
  **/
  ...
  public PaginatedPagerDutyProfileList next(URI next) {
  ...
  **/
  ...
  public PaginatedPagerDutyProfileList previous(URI previous) {
  ...
  **/
  ...
  public PaginatedPagerDutyProfileList results(List<PagerDutyProfile> results) {
    
    this.results = results;
    return this;
  }

  public PaginatedPagerDutyProfileList addResultsItem(PagerDutyProfile resultsItem) {
  ...
  **/
  ...
  public List<PagerDutyProfile> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(List<PagerDutyProfile> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaginatedPagerDutyProfileList paginatedPagerDutyProfileList = (PaginatedPagerDutyProfileList) o;
    return Objects.equals(this.count, paginatedPagerDutyProfileList.count) &&
        equalsNullable(this.next, paginatedPagerDutyProfileList.next) &&
        equalsNullable(this.previous, paginatedPagerDutyProfileList.previous) &&
        Objects.equals(this.results, paginatedPagerDutyProfileList.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedPagerDutyProfileList {\n");
