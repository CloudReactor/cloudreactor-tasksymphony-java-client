...
@JsonPropertyOrder({
  WorkflowTaskInstance.JSON_PROPERTY_URL,
  WorkflowTaskInstance.JSON_PROPERTY_UUID,
  WorkflowTaskInstance.JSON_PROPERTY_NAME,
  WorkflowTaskInstance.JSON_PROPERTY_DESCRIPTION,
  WorkflowTaskInstance.JSON_PROPERTY_WORKFLOW,
  WorkflowTaskInstance.JSON_PROPERTY_TASK,
  WorkflowTaskInstance.JSON_PROPERTY_START_TRANSITION_CONDITION,
  WorkflowTaskInstance.JSON_PROPERTY_MAX_COMPLETE_EXECUTIONS,
  WorkflowTaskInstance.JSON_PROPERTY_SHOULD_EVAL_TRANSITIONS_AFTER_FIRST_EXECUTION,
  WorkflowTaskInstance.JSON_PROPERTY_CONDITION_COUNT_THRESHOLD,
  WorkflowTaskInstance.JSON_PROPERTY_CONDITION_RATIO_THRESHOLD,
  WorkflowTaskInstance.JSON_PROPERTY_MAX_AGE_SECONDS,
  WorkflowTaskInstance.JSON_PROPERTY_DEFAULT_MAX_RETRIES,
  WorkflowTaskInstance.JSON_PROPERTY_FAILURE_BEHAVIOR,
  WorkflowTaskInstance.JSON_PROPERTY_ALLOW_WORKFLOW_EXECUTION_AFTER_FAILURE,
  WorkflowTaskInstance.JSON_PROPERTY_TIMEOUT_BEHAVIOR,
  WorkflowTaskInstance.JSON_PROPERTY_ALLOW_WORKFLOW_EXECUTION_AFTER_TIMEOUT,
  WorkflowTaskInstance.JSON_PROPERTY_ENVIRONMENT_VARIABLES_OVERRIDES,
  WorkflowTaskInstance.JSON_PROPERTY_ALLOCATED_CPU_UNITS,
  WorkflowTaskInstance.JSON_PROPERTY_ALLOCATED_MEMORY_MB,
  WorkflowTaskInstance.JSON_PROPERTY_USE_TASK_ALERT_METHODS,
  WorkflowTaskInstance.JSON_PROPERTY_UI_COLOR,
  WorkflowTaskInstance.JSON_PROPERTY_UI_ICON_TYPE,
  WorkflowTaskInstance.JSON_PROPERTY_UI_SCALE,
  WorkflowTaskInstance.JSON_PROPERTY_UI_CENTER_MARGIN_TOP,
  WorkflowTaskInstance.JSON_PROPERTY_UI_CENTER_MARGIN_LEFT,
  WorkflowTaskInstance.JSON_PROPERTY_CREATED_AT,
  WorkflowTaskInstance.JSON_PROPERTY_UPDATED_AT
})
@JsonTypeName("WorkflowTaskInstance")
...
public class WorkflowTaskInstance {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, workflowTaskInstance.url) &&
        Objects.equals(this.uuid, workflowTaskInstance.uuid) &&
        Objects.equals(this.name, workflowTaskInstance.name) &&
        Objects.equals(this.description, workflowTaskInstance.description) &&
        Objects.equals(this.workflow, workflowTaskInstance.workflow) &&
        Objects.equals(this.task, workflowTaskInstance.task) &&
        Objects.equals(this.startTransitionCondition, workflowTaskInstance.startTransitionCondition) &&
        equalsNullable(this.maxCompleteExecutions, workflowTaskInstance.maxCompleteExecutions) &&
        Objects.equals(this.shouldEvalTransitionsAfterFirstExecution, workflowTaskInstance.shouldEvalTransitionsAfterFirstExecution) &&
        equalsNullable(this.conditionCountThreshold, workflowTaskInstance.conditionCountThreshold) &&
        equalsNullable(this.conditionRatioThreshold, workflowTaskInstance.conditionRatioThreshold) &&
        equalsNullable(this.maxAgeSeconds, workflowTaskInstance.maxAgeSeconds) &&
        Objects.equals(this.defaultMaxRetries, workflowTaskInstance.defaultMaxRetries) &&
        Objects.equals(this.failureBehavior, workflowTaskInstance.failureBehavior) &&
        Objects.equals(this.allowWorkflowExecutionAfterFailure, workflowTaskInstance.allowWorkflowExecutionAfterFailure) &&
        Objects.equals(this.timeoutBehavior, workflowTaskInstance.timeoutBehavior) &&
        Objects.equals(this.allowWorkflowExecutionAfterTimeout, workflowTaskInstance.allowWorkflowExecutionAfterTimeout) &&
        equalsNullable(this.environmentVariablesOverrides, workflowTaskInstance.environmentVariablesOverrides) &&
        equalsNullable(this.allocatedCpuUnits, workflowTaskInstance.allocatedCpuUnits) &&
        equalsNullable(this.allocatedMemoryMb, workflowTaskInstance.allocatedMemoryMb) &&
        Objects.equals(this.useTaskAlertMethods, workflowTaskInstance.useTaskAlertMethods) &&
        Objects.equals(this.uiColor, workflowTaskInstance.uiColor) &&
        Objects.equals(this.uiIconType, workflowTaskInstance.uiIconType) &&
        equalsNullable(this.uiScale, workflowTaskInstance.uiScale) &&
        equalsNullable(this.uiCenterMarginTop, workflowTaskInstance.uiCenterMarginTop) &&
        equalsNullable(this.uiCenterMarginLeft, workflowTaskInstance.uiCenterMarginLeft) &&
        Objects.equals(this.createdAt, workflowTaskInstance.createdAt) &&
        Objects.equals(this.updatedAt, workflowTaskInstance.updatedAt);
  }
